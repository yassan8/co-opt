...
function detectorFromBlock(block: Block | undefined): CoherentDetectorSpec {
  ...
  return {
    ...
    calibrationMinUm: finite(p.calibrationMinUm, -80),
    calibrationMaxUm: finite(p.calibrationMaxUm, 80),
