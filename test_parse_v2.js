...
function parsePatentAsphereTerms(line) {
  ...
  // Adjusted to handle "AL", "Ad", and potential "--" or "-" properly
  const orderPattern = new RegExp(`\\b(?:A|Ad|AL|r|d|v|N|M|E|F|G|H|I|J|K|L|P|Q|S|T|U|V|W|Z)\\s*(\\d{1,2})\\s*[:=]*\\s*(-?\\s*-?\\s*${PATENT_NUMBER_SOURCE})`, 'gi');
