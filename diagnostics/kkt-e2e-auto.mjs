...
await runCommand('node', ['--experimental-strip-types', 'diagnostics/kkt-e2e-benchmark.mjs', ...benchmarkArgs]);
await runCommand('node', ['--experimental-strip-types', 'diagnostics/kkt-e2e-analyze.mjs', ...analyzeArgs]);
